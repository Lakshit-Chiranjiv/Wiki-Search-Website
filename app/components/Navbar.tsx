...
const Navbar = (props: Props) => {
  return (
    <div className="bg-slate-600 text-white/90 flex flex-col justify-around items-center md:items-center md:flex-row gap-4 sticky top-0 drop-shadow-lg p-4 py-8">
