...
const About = () => {
  return (
    <div className='text-white/80 text-base md:text-xl'>
        ...
        <br />
        <p>I have a lot of experience working on <strong className='font-semibold'>React</strong> and <strong className='font-semibold'>Next.js</strong> and I am currently adapting on to NextJS 13. I have also worked on <strong className='font-semibold'>Node.js</strong> and <strong className='font-semibold'>Express.js</strong> for backend development. I have also worked on <strong className='font-semibold'>MongoDB</strong> and <strong className='font-semibold'>PostgreSQL</strong> for database management.</p>
    </div>
  )
}
